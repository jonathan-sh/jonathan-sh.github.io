...
const source = {
    ...
    'education': [
        ...
        '',
        '<b style="color:#00ff00">Centro Universitário Toledo,  Analysis and systems development</b>',
        '<div style="color:#00ff00">January 2014 – December 2017<b>',
        '&nbsp',
        `In graduation I had contact with:`,
        '&nbsp ✓ Algorithms and Programming Logic',
        '&nbsp ✓ Applied math',
        '&nbsp ✓ Software Engineering',
        '&nbsp ✓ Structured Systems Analysis and Projects',
        '&nbsp ✓ Structured Programming Language',
        '&nbsp ✓ Project Management',
        '&nbsp ✓ Database',
        '&nbsp ✓ Web development',
        '&nbsp ✓ MOBILE development',
        '&nbsp ✓ Among other contents',
        '&nbsp',
        'I also had the opportunity to participate in academic events such as scientific initiation and programming competitions.',
        '&nbsp',
    ],
    'courses':[
        '&nbsp&nbsp&nbsp',
        ...
        '',
        'Kafka, Alura | 2020 – 2020',
        'React, Alura | 2019 – 2019',
        '',
    ],
    'help':[
        ...
        '<b style="color:#a7ff00">education</b> to get education',
        '<b style="color:#a7ff00">about</b> to get about text',
        '<b style="color:#a7ff00">courses</b> to get latest courses',
...
const getPromisesByCommand = {
    ...
    'courses': () => buildPromises(['courses']), 
    'education': () => buildPromises(['education']), 
